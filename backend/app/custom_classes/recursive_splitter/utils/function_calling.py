...
from app.custom_classes.recursive_splitter._api import beta, deprecated
from app.custom_classes.recursive_splitter.messages import AIMessage, BaseMessage, HumanMessage, ToolMessage
from app.custom_classes.recursive_splitter.utils.json_schema import dereference_refs
from app.custom_classes.recursive_splitter.utils.pydantic import is_basemodel_subclass

if TYPE_CHECKING:
    from app.custom_classes.recursive_splitter.tools import BaseTool
...
convert_pydantic_to_openai_function = deprecated(
    "0.1.16",
    alternative="app.custom_classes.recursive_splitter.utils.function_calling.convert_to_openai_function()",
    removal="1.0",
...
@deprecated(
    "0.1.16",
    alternative="app.custom_classes.recursive_splitter.utils.function_calling.convert_to_openai_tool()",
    removal="1.0",
)
...
def _convert_python_function_to_openai_function(
    ...
    """
    from app.custom_classes.recursive_splitter.tools.base import create_schema_from_function
...
def _format_tool_to_openai_function(tool: BaseTool) -> FunctionDescription:
    ...
    Returns:
        The function description.
    """
    from app.custom_classes.recursive_splitter.tools import simple
