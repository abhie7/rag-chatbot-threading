    ...
    def merge(self: T, other: BaseCallbackManager) -> T:
        ...
        Example: Merging two callback managers.
            ...
            .. code-block:: python
                ...
                from app.custom_classes.recursive_splitter.callbacks.manager import CallbackManager, trace_as_chain_group
                from app.custom_classes.recursive_splitter.callbacks.stdout import StdOutCallbackHandler
                ...
                with trace_as_chain_group("My Group Name", tags=["tag1"]) as group_manager:
                    ...
                    # [
                    #    <app.custom_classes.recursive_splitter.callbacks.stdout.StdOutCallbackHandler object at ...>,
                    #    <app.custom_classes.recursive_splitter.callbacks.streaming_stdout.StreamingStdOutCallbackHandler object at ...>,
                    # ]
